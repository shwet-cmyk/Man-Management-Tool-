...
from app.chatbot.bll import ChatbotBLL
from app.chatbot.dal import ChatbotDAL
from app.chatbot.schemas import ChatHistoryResponse, ChatMessage, ChatQueryRequest, ChatQueryResponse


class ChatbotBAL:
    def __init__(self, dal: ChatbotDAL | None = None, bll: ChatbotBLL | None = None) -> None:
