...
class WmTimesheet(Base):
    ...
    spent_minutes = Column(BIGINT, nullable=True)
    ...
    expense_total = Column(DECIMAL(14, 2), nullable=False, default=0)
    reimbursement_total = Column(DECIMAL(14, 2), nullable=False, default=0)
