...
## Platform Hardening
- `POST /platform-hardening/global-search/index`
- `POST /platform-hardening/global-search/query`
- `POST /platform-hardening/global-search/log/{search_log_id}/click`
- `GET /platform-hardening/global-search/reports/usage`
- `GET /platform-hardening/global-search/analytics/top-queries`
- `POST /platform-hardening/settings-registry`
- `GET /platform-hardening/settings-registry`
- `GET /platform-hardening/settings-registry/reports/changes`
- `GET /platform-hardening/settings-registry/analytics/unstable`
- `POST /platform-hardening/exceptions`
- `POST /platform-hardening/exceptions/{exception_id}/action`
- `GET /platform-hardening/exceptions/reports/active`
- `GET /platform-hardening/exceptions/analytics/by-type`
- `POST /platform-hardening/feature-flags`
- `POST /platform-hardening/feature-flags/{feature_flag_id}/scopes`
- `GET /platform-hardening/feature-flags/reports/active`
- `GET /platform-hardening/feature-flags/analytics/adoption`
- `POST /platform-hardening/monitoring/policies`
- `POST /platform-hardening/monitoring/policies/versions`
- `POST /platform-hardening/monitoring/policies/acceptance`
- `GET /platform-hardening/monitoring/reports/acceptance`
- `POST /platform-hardening/import/jobs`
- `GET /platform-hardening/import/jobs/reports/history`
- `GET /platform-hardening/import/jobs/analytics/failure-patterns`
- `POST /platform-hardening/integration-governance/api-keys`
- `POST /platform-hardening/integration-governance/webhooks`
- `POST /platform-hardening/integration-governance/webhook-delivery`
- `GET /platform-hardening/integration-governance/reports/webhook-delivery`
- `GET /platform-hardening/integration-governance/analytics/api-key-usage`
- `POST /platform-hardening/impersonation/start`
- `POST /platform-hardening/impersonation/{session_id}/end`
- `POST /platform-hardening/archival/policies`
- `POST /platform-hardening/archival/jobs/run`
- `POST /platform-hardening/archival/restore-requests`
- `GET /platform-hardening/archival/reports/jobs`
- `GET /platform-hardening/archival/analytics/storage-trend`
